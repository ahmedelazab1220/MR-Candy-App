...
class CompanyServiceTest {
	...
	/**
	 * Test case to verify that the getAllCompanies() method returns an empty list
	...
	/**
	 * Test case to verify that an exception is thrown when creating a Company with
	 * invalid data.
	 *
	 * @throws IOException if an error occurs during the file upload process
	 */
	...
	/**
     * Test case to verify that a NotFoundException is thrown when the Company is not found when deleting a Company.
     *
	...
	/**
     * Test case to verify that the deleteCompany method handles image deletion failure
	...
	/**
     * This test method verifies that the deleteCompany method successfully deletes a Company.
     *
     * @throws IOException if an error occurs during the file deletion process
     */
	@Test
	...
	/**
     * Test case to verify that the deleteCompany method handles exceptions during deletion of a Company.
     *
     * @throws IOException if an error occurs during the file deletion process
     */
	@Test
	...
	/**
     * Test case to verify that the `existCompanyByName` method returns `true` when the Company exists.
     *
     * This test case sets up a mocked `CompanyRepository` to return `true` when `existsByName` is called with the specified `CompanyName`.
     * Then it calls the `existCompanyByName` method with the same `CompanyName` and asserts that the returned value is `true`.
     * Finally, it verifies that `existsByName` was called exactly once with the specified `CompanyName`.
     *
	...
	/**
     * Test case to verify that a NotFoundException is thrown when the Company does not exist.
     *
	...
	/**
     * Test case to verify that a NotFoundException is thrown when the Company does not exist during the updateCompany method.
     *
	 ...
	 * during the updateCompany method.
	 *
	 * @throws IOException if an I/O error occurs during the test
	 */
	@Test
